...
echo '<script type="text/javascript">
       window.onload = function () { alert("EL DIA 19 DE ABRIL  2024 EL HORARIO DE LABORES ES HASTA LAS 12:00 PM" ); } 
</script>'; 
?> 
...
<section>
 ...
 Horario de oficina: 08:00 hrs a 17:00 hrs. <i class="fa fa-clock-o" aria-hidden="true"></i>Horario de almacén de 08:00 a 16:30 hrs.</h4>
			
   
   <h4 class="md bold white pa5 athelas f1"> 
  
  
  Para cualquier consulta, sugerencia, petición o queja respecto a nuestros servicios, puede ponerse en contacto con nosotros a través de: buzon@lema.com.mx  </h4>
        </div>
      </div>
    </div>
  </div>
...
<footer class="bg-black-10">
  <div class="container">
    <div class="row pa5">
      ...
      <p class="b">&copy;2017 NEGOCIACIONES INTERNACIONALES LEMA, S.A. DE C.V. &middot; </p>
